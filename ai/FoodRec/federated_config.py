...
USER_ENHANCED_DATASET_FILE = os.path.join(
    BASE_DIR, "user_dataset_enhanced.csv")
...
NUMERIC_COLS = [
    ...
    # Restaurant's original average rating (ensure this column name exists after loading/renaming)
    'rating_biz',
...
CUISINE_TYPES = ["粤菜", "川菜", "湘菜", "鲁菜", "苏菜", "浙菜", "闽菜", "徽菜",
                 ...
                 "面包甜点", "咖啡厅", "酒吧", "小吃夜宵"]
GENDERS = ['男', '女']
ORIGINS = ['北京', '上海', '广东', '四川', '浙江', '江苏',
           '湖南', '湖北', '山东', '东北地区', '其他地区']  # Simplified
...
SERVER_HOST = '0.0.0.0'
SERVER_PORT = 5000
GLOBAL_MODEL_SAVE_PATH = os.path.join(
    BASE_DIR, "global_shanghai_food_model.pth")
PREPROCESSOR_SAVE_PATH = os.path.join(
    BASE_DIR, "global_shanghai_preprocessor.joblib")
